                    ...
                    <div className="bg-card border border-border rounded-2xl p-5 sm:p-6 shadow-xs space-y-4">
                      <div className="flex items-center justify-between pb-3 border-b border-border">
                        <div>
                          ...
                          <p className="text-xs text-muted-foreground mt-0.5">
                            {isUsernameLocked
                              ? 'You have already used your 1 allowed username change. Your handle is permanently locked.'
                              : 'You can change your username one time after your autogenerated username. Choose carefully!'}
                          </p>
                        </div>
                        {isUsernameLocked ? (
                          <span className="flex items-center gap-1 text-[11px] font-bold text-muted-foreground bg-secondary px-2.5 py-1 rounded-full border border-border">
                            <Lock className="w-3.5 h-3.5" /> Locked (1/1 Used)
                          </span>
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="relative max-w-md">
                          ...
                          <input
                            ...
                            className="w-full pl-8 pr-10 py-2.5 rounded-xl border border-input bg-background text-sm font-medium focus:ring-2 focus:ring-primary focus:border-primary focus:outline-none transition-all disabled:opacity-60 disabled:cursor-not-allowed"
                          />
                          {isCheckingUsername && (
                        ...
                        <p className="text-xs text-muted-foreground">
                          {isUsernameLocked
                            ? 'Your trading handle cannot be modified again in compliance with platform identity rules.'
                            : 'Requirements: 3-25 characters using lowercase letters, numbers, dots, and underscores. You can only change it once.'}
                        </p>
                        ...
                        {!isUsernameLocked && (
                          <div className="pt-2">
                            ...
                            >
                              ...
                              <span>Save Username (1-Time Only)</span>
                            </button>
                          </div>
                        )}
                      </div>
