      ...
      <form onSubmit={handleSubmit} className="space-y-4 pt-5">
        ...
        <div>
          ...
          <Select value={crypto} onValueChange={(v) => setCrypto(v as CryptoCurrency)}>
            <SelectTrigger className="bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 h-12 text-base rounded-xl">
              <SelectValue>
        ...
        <div>
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full justify-between text-left font-normal bg-slate-50 dark:bg-slate-800 border-slate-200 dark:border-slate-700 h-12 text-sm rounded-xl hover:bg-slate-100 dark:hover:bg-slate-750"
