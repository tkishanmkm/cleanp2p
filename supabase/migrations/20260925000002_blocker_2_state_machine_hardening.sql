-- ============================================================================
-- Supabase Migration: 20260925000002_blocker_2_state_machine_hardening.sql
-- Description: Blocker #2 Fix - Database State Machine Hardening
--              1. Disallow state machine bypass (remove CLAIMED -> BROADCASTED and GAS_FUNDED -> BROADCASTED)
--              2. Require valid, non-empty transaction hash for BROADCASTED status
--              3. Maintain strict worker ownership, lease validation, and SECURITY DEFINER controls
-- ============================================================================
